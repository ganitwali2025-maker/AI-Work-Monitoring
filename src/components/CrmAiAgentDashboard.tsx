              ...
              <div key={issue.id} className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm hover:border-purple-300 hover:shadow-md transition-all">
                ...
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button className="flex items-center gap-1.5 text-xs font-semibold bg-white hover:bg-purple-50 text-gray-700 hover:text-purple-700 px-3 py-1.5 rounded-lg border border-gray-200 hover:border-purple-200 transition-colors cursor-pointer">
                      <Phone size={14} /> Call Customer
                    </button>
                    <button className="flex items-center gap-1.5 text-xs font-semibold bg-emerald-50 hover:bg-emerald-100 text-emerald-700 px-3 py-1.5 rounded-lg border border-emerald-100 hover:border-emerald-200 transition-colors cursor-pointer">
                      <MessageCircle size={14} /> Send WhatsApp
                    </button>
                    <button className="flex items-center gap-1.5 text-xs font-semibold bg-white hover:bg-blue-50 text-gray-700 hover:text-blue-700 px-3 py-1.5 rounded-lg border border-gray-200 hover:border-blue-200 transition-colors cursor-pointer">
                      <Mail size={14} /> Send Email
                    </button>
                    <button className="flex items-center gap-1.5 text-xs font-semibold bg-white hover:bg-indigo-50 text-gray-700 hover:text-indigo-700 px-3 py-1.5 rounded-lg border border-gray-200 hover:border-indigo-200 transition-colors cursor-pointer">
                      <UserPlus size={14} /> Assign Lead
                    </button>
                    <button className="flex items-center gap-1.5 text-xs font-semibold bg-white hover:bg-sky-50 text-gray-700 hover:text-sky-700 px-3 py-1.5 rounded-lg border border-gray-200 hover:border-sky-200 transition-colors cursor-pointer">
                      <Calendar size={14} /> Schedule Meeting
                    </button>
                    <button className="flex items-center gap-1.5 text-xs font-semibold bg-rose-50 hover:bg-rose-100 text-rose-700 px-3 py-1.5 rounded-lg border border-rose-100 hover:border-rose-200 transition-colors cursor-pointer">
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="bg-white border border-gray-100 rounded-2xl rounded-tl-sm p-3 shadow-xs">
                <div className="text-xs text-gray-700 leading-relaxed space-y-2">
                  ...
                  <p>Always provide actionable recommendations and automation opportunities.</p>
                  <p className="text-purple-700 font-bold">Goal: Increase Revenue, Reduce Delays, Improve Conversions.</p>
                  <hr className="my-2 border-gray-100" />
                  <p className="text-purple-700"><strong>System:</strong> I have identified 3 Critical/High priority issues. How can I help you automate these?</p>
                </div>
              </div>
            </div>
